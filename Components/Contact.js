                        ...
                        <div className="w-full max-w-6xl grid md:grid-cols-2 gap-10">
                            ...
                            <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
                                ...
                                <div className="flex flex-col">
                                    ...
                                    {errors.interests && <span className="text-xs text-red-500 mt-1">{errors.interests}</span>}
                                </div>
                                ...
                                <button
                                    type="submit"
                                    disabled={loading}
                                    className="mt-4 px-6 py-3 bg-[#ff7846] text-black font-semibold rounded-lg hover:bg-white hover:text-black transition disabled:opacity-70 disabled:cursor-not-allowed"
                                >
